...
local ElysianAssetsTable = {
    ["Elysian/assets/Logo.png"] = "rbxassetid://14049259616"
}
local configPath = "Elysian/Configs/"..game.PlaceId..".json"
local configPath2 = "Elysian/Configs/"..game.PlaceId
if not isfile(configPath) then
	makefolder("Elysian")
	makefolder("Elysian/Configs/")
...
do
    ...
    Highlights.BackgroundColor3 = Color3.fromRGB(0,191,255)
    ...
    Highlights_2.BackgroundColor3 = Color3.fromRGB(0,191,255)
    ...
    Highlights_3.BackgroundColor3 = Color3.fromRGB(0,191,255)
    ...
    Highlights_4.BackgroundColor3 = Color3.fromRGB(0,191,255)
    ...
    Highlights_5.BackgroundColor3 = Color3.fromRGB(0,191,255)
    ...
    function GuiLibrary:SelfDestruct()
        ...
        buttonbind = true
        configsystem = true
        warningNotification("Elysian", "Gui SelfDestruct!", 3)
    end
    ...
    function GuiLibrary.add(text)
        ...
        TextLabel.Font = Enum.Font.SourceSans
        TextLabel.Text = text
        TextLabel.TextColor3 = Color3.fromRGB(0,191,255)
            ...
            Function = function(callback)
                ...
                if callback then
                    ...
                    task.spawn(function()
                        ...
                        antivoidpart.Position = lplr.Character.HumanoidRootPart.Position - Vector3.new(0, 13, 0)
    ...
    runFunction(function()
    texture = GuiLibrary.CreateOptionsButton({
        Name = "texture",
        Tab = misc,
        Default = false,
            Function = function(callback)
    ...
    runFunction(function()
        Keystrokes = GuiLibrary.CreateOptionsButton({
            Name = "Keystrokes",
            Tab = combat,
            Default = false,
                Function = function(callback)
...
runFunction(function()
        ESP = GuiLibrary.CreateOptionsButton({
            Name = "ESP",
            Tab = misc,
            Default = false,
                Function = function(callback)
...
runFunction(function()
    EnchantedSword = GuiLibrary.CreateOptionsButton({
...
runFunction(function()
        LOGO = GuiLibrary.CreateOptionsButton({
            Name = "LOGO",
            Tab = misc,
            Default = false,
                Function = function(callback)
